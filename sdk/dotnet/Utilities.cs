...
namespace Lbrlabs.PulumiPackage.Remotecertificate
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Lbrlabs.PulumiPackage.Remotecertificate.version.txt");
    ...
    internal sealed class RemotecertificateResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RemotecertificateResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
