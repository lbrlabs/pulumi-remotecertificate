module github.com/lbrlabs/pulumi-remotecertificate/examples

go 1.19

require github.com/pulumi/pulumi/pkg/v3 v3.60.1
...
require (
	...
	github.com/pulumi/pulumi/sdk/v3 v3.60.1 // indirect
